...
def build_nlu_model(vocab_size, num_intents, max_len):
    ...
    lstm = layers.Bidirectional(layers.LSTM(64, return_sequences=False))(embedding)

    intent_dropout = layers.Dropout(0.3)(lstm)
    intent_output = layers.Dense(num_intents, activation='softmax', name="intent_output")(intent_dropout)
